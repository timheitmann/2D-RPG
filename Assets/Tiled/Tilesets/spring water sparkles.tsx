...
<tileset version="1.9" tiledversion="1.9.1" name="spring water sparkles B" tilewidth="16" tileheight="16" tilecount="12" columns="4">
 <image source="../spring animations/spring water sparkles B.png" width="64" height="48"/>
 <tile id="0">
  <animation>
